...
const sectionSchema = z.union([
  z.object({ type: z.literal('rich_text'), heading: z.string().optional(), body: z.string() }),
  ...
  z.object({ type: z.literal('gallery'), heading: z.string().optional(), images: z.array(imageEntry).min(1) }),
